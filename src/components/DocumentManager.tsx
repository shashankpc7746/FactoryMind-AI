              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm">File Name</th>
                    <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm">Type</th>
                    <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm hidden sm:table-cell">Size</th>
                    <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm hidden md:table-cell">Upload Date</th>
                    <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm">Status</th>
                    <th className="text-right py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {documents.map((doc) => (
                    <tr key={doc.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                      <td className="py-3 sm:py-4 px-2 sm:px-4">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                          ...
                          <span className="font-medium text-xs sm:text-sm truncate max-w-[120px] sm:max-w-none">{doc.fileName}</span>
                        </div>
                      </td>
                      <td className="py-3 sm:py-4 px-2 sm:px-4">
                        <Badge variant="secondary" className="text-[10px] sm:text-xs">{doc.type}</Badge>
                      </td>
                      <td className="py-3 sm:py-4 px-2 sm:px-4 text-muted-foreground text-xs sm:text-sm hidden sm:table-cell">{doc.size}</td>
                      <td className="py-3 sm:py-4 px-2 sm:px-4 text-muted-foreground text-xs sm:text-sm hidden md:table-cell">
